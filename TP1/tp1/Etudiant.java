...
public class Etudiant {
    ...
    String prenom;
    int matricule;
    Date dateNaissance; // Cette variable d'instance est du type Date, disponible dans le même package
    
    /*
     * Méthode main qui crée un étudiant et initialise les variables d'instance au
     * départ de la ligne de commande
     * 
     */
